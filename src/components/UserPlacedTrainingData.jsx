    ...
    return (
        <>
            ...
            <div style={{
                ...
                backgroundImage: `url(${placedTrainingData})`,
                ...
                {responseData.length > 0 ?
                    <>
                        <h1 className={style.tableHeading}>Placed Training Data</h1>
                    ...
                    : <h1 style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "50vh" }}>Your are Not Placed Any Requests</h1>}
            </div>
        </>
    )
}