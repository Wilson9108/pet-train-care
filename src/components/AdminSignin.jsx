...
export default function AdminSignin() {
    const {verifyAdminToken,setIsAdminLoggedIn}=useContext(mycontext)
    ...
    return (
        <>
            <div className={`${style.formContainer} ${style.setImageToAdmin}`}>
                <div className={style.formBox}>
                    <div className={style.formMin} style={{ backgroundColor: "rgba(137, 115, 115, 0.08)" }}>
                        <form id={style.form} onSubmit={handleSubmit}>
                            <h1 className={style.formHeader}>Admin Signin</h1>
                            <hr></hr>
                            ...
                            <div>
                                <p className='text-center text-light'  >Don't Have An Account?
                                    <Link className={style.signupLink} to="/adminsignup">Signup</Link></p>
                            </div>
